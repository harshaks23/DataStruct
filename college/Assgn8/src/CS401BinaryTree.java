...
public class CS401BinaryTree<E>  {
  ...
  if(t!=null)
   ...
   // To calculate size iteratively
   private int size_piterative(TreeNode<E> t){
	   int num_nodes = 0;

	      //to calculate size in an iterative way
	      TreeNode<E>current =t;
	 	 Stack<TreeNode<E>>ab=new Stack<TreeNode<E>>();
	 	 boolean d=true;
	 	 while(d){
	 		 if(current!=null){
   ...
   private void inorder_p_iterative(TreeNode<E> t)  {
	   TreeNode<E>current=t;
		 Stack<TreeNode<E>>temp=new Stack<TreeNode<E>>();
		 boolean d=true;
		 while(d){
			 if(current!=null)
   ...
   public static void main(String[] args)  {
       ...
       *                     9    8   15
       */
      System.out.println("size through Recursive");
      ...
      System.out.println("\n\n Iterative  size");
      System.out.println("The tree has " + bt.size_iterative() + " nodes.");
      System.out.println("\n\n iterative Inorder:");
