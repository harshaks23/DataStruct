...
public class CS401ArrayImpl3<E> {
	...
	private E[] elements;
	   ...
	   public CS401ArrayImpl3(int size)
	...
	capacity=capacity*2;
	   ...
	   public CS401ArrayImpl3 <E> subList(int from,int to){
		   CS401ArrayImpl3<E> temp= new CS401ArrayImpl3<E>(elements.length);
